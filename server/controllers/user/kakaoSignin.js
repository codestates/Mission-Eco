...
module.exports = async (req, res) => {
  ...
  try {
    axios
      .post(
        `https://kauth.kakao.com/oauth/token?grant_type=authorization_code&client_id=${process.env.KAKAO_REST_API}&redirect_uri=https://${process.env.KAKAO_REDIRECT_URI}&code=${req.body.authorizationCode}`,
        {
          headers: {
